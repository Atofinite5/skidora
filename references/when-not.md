...
The canonical **7-Rung Ladder**, SOLID architectural creed, and adaptive execution principles are maintained in [`skills/skidora-when-not/SKILL.md`](../skills/skidora-when-not/SKILL.md).
